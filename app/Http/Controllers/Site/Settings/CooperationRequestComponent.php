...
class CooperationRequestComponent extends Component
{
    public $slider;
    public $description , $name , $family , $email , $mobile , $StoreName , $website , $instagram , $result , $alert ;
    ...
    public function mount()
    {
        ...
        $this->description =  Setting::getSingleRow('cooperation_request_description');
    }

    public function render()
    {
        return view('site.settings.cooperation-request-component')
	...
	public function newPartner()
	{
        ...
        $parter->website = $this->website;
        $parter->instagram = $this->instagram;
        $parter->StoreName = $this->StoreName;
