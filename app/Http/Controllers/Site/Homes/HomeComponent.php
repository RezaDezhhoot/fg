...
class HomeComponent extends Component
{
    ...
    public function mount()
    {
        ...
        $this->category_banner = Setting::where('name', 'category_banner')->pluck('value', 'id','title','url','image');
        ...
        $this->recentComments = Comment::with('user','product')
            ->latest()
            ->isConfirmed()
