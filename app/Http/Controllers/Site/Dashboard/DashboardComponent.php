...
class DashboardComponent extends Component
{
    ...
    {
        SEOMeta::setTitle('داشبورد - فارس گیمر');
        OpenGraph::setTitle('داشبورد - فارس گیمر');
        TwitterCard::setTitle('داشبورد - فارس گیمر');
        JsonLd::setTitle('داشبورد - فارس گیمر');
    ...
    {
        $this->transactions = auth()->user()->walletTransactions()->where('confirmed', 1)->take(35)->get();

        return view('site.dashboard.dashboard-component')
