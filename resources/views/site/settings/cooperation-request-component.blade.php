<div>
    <section id="box-slider-request" class="main-style-page flex-box flex-justify-space">
        <div wire:ignore id="box-img-defult-request-mobile" class="width-max">
            ...
            <div class="message-right-faqs">
                ...
                <form id="form-request" class="form-submit-disable">
                    <div class="form-request-grid">
                        ...
                        <div>
                            <label for="number-request">نام فروشگاه</label>

                            <input class="input-style" type="text" id="StoreName-request" placeholder="نام فروشگاه"
                                wire:model.defer="StoreName">
                        ...
                        <div>
                            <label for="number-request">پیج اینستاگرام</label>

                            <input class="input-style" type="text" id="instagram-request"
                                placeholder="پیج اینستاگرام" wire:model.defer="instagram">
                        ...
                        <div>
                            <label for="number-request">آدرس وب سایت</label>

                            <input class="input-style" type="text" id="website-request" placeholder="آدرس وبسایت"
        ...
        <div wire:ignore class="item-slider-request
