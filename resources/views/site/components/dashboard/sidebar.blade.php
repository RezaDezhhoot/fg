    ...
    <div id="box-menu-dashboard">
        ...
        <div class="box-item-menu-dashboard">
            <ul>
                    ...
                    <li
                        ...
                        <svg class="active hidden" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                ...
                                fill="white" />
                            <path
                                d="M1.25 18C1.25 15.3766 3.37665 13.25 6 13.25C8.62335 13.25 10.75 15.3766 10.75 18C10.75 20.6234 8.62335 22.75 6 22.75C3.37665 22.75 1.25 20.6234 1.25 18Z"
                                fill="white" />
                            <path
                                ...
                                fill="white" />
                            <path
                                d="M13.25 6C13.25 3.37665 15.3766 1.25 18 1.25C20.6234 1.25 22.75 3.37665 22.75 6C22.75 8.62335 20.6234 10.75 18 10.75C15.3766 10.75 13.25 8.62335 13.25 6Z"
                                fill="white" />
                        </svg>
                ...
                <a href="{{ route('dashboard.orders') }}">
                    <li
                        ...
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path d="M13.5 20C13.5 20 14.5 20 15.5 22C15.5 22 18.6765 17 21.5 16" stroke="#808191"
                ...
                <a href="{{ route('dashboard.sales-ad') }}">
                    <li
                        class="hover-menu-dashboard flex-box flex-right {{ \Illuminate\Support\Facades\Route::currentRouteName() == 'dashboard.sales-ad' ? ' item-menu-dashboard-active' : '' }}">
                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10.5 8.5H18.5M10.5 12.5H13M18.5 12.5H16M10.5 16.5H13M18.5 16.5H16" stroke="#808191" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M7 8H6C4.11438 8 3.17157 8 2.58579 8.58579C2 9.17157 2 10.1144 2 12V18.5C2 19.8807 3.11929 21 4.5 21C5.88071 21 7 19.8807 7 18.5V8Z" stroke="#808191" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M16 4H11C10.07 4 9.60504 4 9.22354 4.10222C8.18827 4.37962 7.37962 5.18827 7.10222 6.22354C7 6.60504 7 7.07003 7 8V18.5C7 19.8807 5.88071 21 4.5 21H16C18.8284 21 20.2426 21 21.1213 20.1213C22 19.2426 22 17.8284 22 15V10C22 7.17157 22 5.75736 21.1213 4.87868C20.2426 4 18.8284 4 16 4Z" stroke="#808191" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>

                        <svg class="active hidden" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.82782 6.75L6.81752 6.75C7.33036 6.75 7.74609 7.1828 7.74609 7.71667V8.68334H5.88895C4.98724 8.68334 4.40436 8.68539 3.97489 8.7455C3.57214 8.80187 3.4459 8.89288 3.37521 8.96647C3.30453 9.04005 3.2171 9.17147 3.16295 9.59075C3.10521 10.0378 3.10324 10.6446 3.10324 11.5833V17.8667C3.10324 18.6675 3.90541 19.3167 4.67466 19.3167C5.44392 19.3167 6.24609 18.6675 6.24609 17.8667H7.74609C7.74609 19.7352 6.29102 21.25 4.4961 21.25C2.70117 21.25 1.2461 19.7352 1.2461 17.8667L1.2461 11.5197C1.24605 10.6628 1.24601 9.92441 1.32237 9.33314C1.40421 8.69947 1.58876 8.09207 2.06201 7.59939C2.53527 7.10672 3.11874 6.9146 3.72743 6.82941C4.2954 6.74991 5.00466 6.74995 5.82782 6.75Z" fill="white"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M19.3918 2.86657C18.5248 2.75001 17.4225 2.75003 16.0549 2.75005L10.8842 2.75002C10.0662 2.74975 9.50809 2.74957 9.02943 2.87783C7.73533 3.22458 6.72453 4.23538 6.37778 5.52948C6.24952 6.00814 6.24971 6.56629 6.24997 7.38425V7.38425L6.25 18C6.25 18.9665 5.4665 19.75 4.5 19.75C4.08579 19.75 3.75 20.0858 3.75 20.5C3.75 20.9143 4.08579 21.25 4.5 21.25H16.0549C17.4225 21.2501 18.5248 21.2501 19.3918 21.1335C20.2919 21.0125 21.0497 20.7536 21.6517 20.1517C22.2536 19.5498 22.5125 18.7919 22.6335 17.8918C22.75 17.0248 22.75 15.9225 22.75 14.5549V9.44518C22.75 8.07759 22.75 6.97527 22.6335 6.1083C22.5125 5.20819 22.2536 4.45032 21.6517 3.8484C21.0497 3.24648 20.2919 2.98759 19.3918 2.86657ZM10.5 7.25C10.0858 7.25 9.75 7.58579 9.75 8C9.75 8.41421 10.0858 8.75 10.5 8.75H18.5C18.9142 8.75 19.25 8.41421 19.25 8C19.25 7.58579 18.9142 7.25 18.5 7.25H10.5ZM10.5 11.25C10.0858 11.25 9.75 11.5858 9.75 12C9.75 12.4142 10.0858 12.75 10.5 12.75H13C13.4142 12.75 13.75 12.4142 13.75 12C13.75 11.5858 13.4142 11.25 13 11.25H10.5ZM16 11.25C15.5858 11.25 15.25 11.5858 15.25 12C15.25 12.4142 15.5858 12.75 16 12.75H18.5C18.9142 12.75 19.25 12.4142 19.25 12C19.25 11.5858 18.9142 11.25 18.5 11.25H16ZM10.5 15.25C10.0858 15.25 9.75 15.5858 9.75 16C9.75 16.4142 10.0858 16.75 10.5 16.75H13C13.4142 16.75 13.75 16.4142 13.75 16C13.75 15.5858 13.4142 15.25 13 15.25H10.5ZM16 15.25C15.5858 15.25 15.25 15.5858 15.25 16C15.25 16.4142 15.5858 16.75 16 16.75H18.5C18.9142 16.75 19.25 16.4142 19.25 16C19.25 15.5858 18.9142 15.25 18.5 15.25H16Z" fill="white"/>
                        </svg>

                        <span>آگهی اکانت</span>
                    </li>
                </a>
                ...
                <a href="{{ route('dashboard.comments') }}">
                    <li
                        ...
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M8 13.5H16M8 8.5H12" stroke="#808191" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                    ...
                    <li
                        ...
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                ...
                                stroke="#808191" stroke-width="1.5" stroke-miterlimit="10" />
                        </svg>
                    ...
                    <li
                        ...
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                ...
                                stroke="#808191" stroke-width="1.5" stroke-linejoin="round" />
                            <path d="M9 3.5L9 20.5" stroke="#808191" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
