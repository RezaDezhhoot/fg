    ...
    <form>
        <div class="mt-[1rem] bg-white rounded-[1rem] p-[2rem] box-page-create-ticket">
            ...
            <div>
                ...
                <div class="box-radio-form-product w-full grid grid-cols-2 gap-2 my-[1rem]">
                    <input class="!rounded-[0.5rem]" label="کالاف" type="radio" name="first">

                    <input class="!rounded-[0.5rem]" label="فورت" type="radio" name="first">
                ...
                <div class="flex justify-center">
                    <button type="button" class="input-submit-style !rounded-[0.5rem] !w-[15rem]">مرحله بعد</button>
                </div>
            </div>
        </div>
                ...
                <div>
                    <div>
                        ...
                        <div class="flex justify-center items-center my-[1rem]">
                            <input type="file" accept="image/*" class="upload-input-file-sale hidden">
                            ...
                            <div
                                ...
                                <span class="text-[#808191] mt-[0.5rem] text-center">برای ارسال عکس ضربه بزنید</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-[#3D42DF] text-[14px] font-[700]">4/5</span>
                        </div>

                        <div class="grid grid-cols-3 lg:grid-cols-5 gap-2 my-[1rem]">
                            <input type="file" accept="image/*" class="upload-input-file-sale hidden">
                            ...
                            <div
                                ...
                                <span class="mt-[0.5rem] text-center text-[10px] text-[#808191]">افزودن عکس</span>
                            </div>
                            ...
                            <div
                                ...
                                <img class="w-full h-full rounded-[0.5rem]"
                                    src="https://www.farsgamer.com/media/6651a73a40064.jpg" alt="">
                            ...
                            <div
                                class="w-full p-[0.25rem] bg-[#F8F9FB] bo4rder border-[#BDBDC7] rounded-[0.5rem] cursor-pointer flex flex-col justify-center items-center">
                                <img class="w-full h-full rounded-[0.5rem]"
                                    src="https://www.farsgamer.com/media/6651a73a40064.jpg" alt="">
                    ...
                    <div class="mt-[1rem]">
                        ...
                        <input type="text" id="name"
                            ...
                            placeholder="لطفا اسم آگهی خود را وارد نمایید">
                    </div>
                    ...
                    <div class="mt-[1rem]">
                        ...
                        <div id="box-safe-transition-create"
        ...
        <div class="mt-[1rem] bg-white rounded-[1rem] p-[2rem] box-page-create-ticket hidden">
            ...
            <div>
                <div>
                    <div>
                        ...
                        <div>
                            <textarea
                                ...
                                placeholder="لطفا متن موضوع  خود را وارد نمایید"></textarea>
                        </div>
                    </div>

                    <div class="mt-[1rem]">
                        <label class="flex items-center space-x-3">
                            <input type="checkbox" class="custom-checkbox custom-checkbox-black appearance-none">
                    ...
                    <div class="mt-[1rem]">
                        ...
                        <div class="box-radio-form-product w-full grid grid-cols-2 lg:grid-cols-4 gap-2 my-[1rem]">
                            <input class="!rounded-[0.5rem]" label="ایتا" type="radio" name="first">

                            <input class="!rounded-[0.5rem]" label="تلگرام" type="radio" name="first">

                            <input class="!rounded-[0.5rem]" label="ایسنتا" type="radio" name="first">

                            <input class="!rounded-[0.5rem]" label="واتساپ" type="radio" name="first">
                        </div>
                    </div>
                ...
                <div class="flex flex-col justify-center items-center mt-[1.5rem]">
                    ...
                    <button type="button" class="input-submit-style !rounded-[0.5rem] !w-[70%]">ارسال</button>
                </div>
            </div>
        </div>
        ...
        <div class="mt-[1rem] bg-white rounded-[1rem] p-[2rem] box-page-create-ticket hidden">
            ...
            <div>
                ...
                <div class="flex flex-col justify-center items-center mt-[1.5rem]">
                    <button type="button" class="input-submit-style !rounded-[0.5rem] !w-[70%]">متوجه شدم</button>
                </div>
            </div>
        </div>
