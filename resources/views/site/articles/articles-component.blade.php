        ...
        <div class="header-page-articles flex-box flex-justify-space">
            ...
            <div class="select-box" wire:ignore>
                ...
                <div class="more-select-box hide-item" >
                    <ul>
                        <li wire:click="$set('category','')" class="item-more-select-box">
                            <span class="text-item-more-select-box">همه</span>
                        </li>
                        @foreach($categories as $value => $item)
                            <li wire:click="$set('category','{{$value}}')" class="item-more-select-box">
                                <span class="text-item-more-select-box">{{ $item }}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
