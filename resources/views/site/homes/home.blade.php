<div>
    ...
    <section class="grid gap-4 mt-4 sm:grid-cols-2 xl:grid-cols-4">
        @foreach (\App\Models\Setting::whereIn('name', ['home_small_five', 'home_small_six', 'home_small_seven', 'home_small_eight'])->get()->pluck('value', 'id') as $banner)
...
@push('scripts')
    <script>
        ...
        $('[data-countdown-hour]').each(function() {
            var $this = $(this),
                finalDate = $(this).data('countdown-hour');
            $this.countdown(finalDate, function(event) {
        ...
        $('[data-countdown-minute]').each(function() {
            var $this = $(this),
                finalDate = $(this).data('countdown-minute');
            $this.countdown(finalDate, function(event) {
        ...
        $('[data-countdown-seconds]').each(function() {
            var $this = $(this),
                finalDate = $(this).data('countdown-seconds');
            $this.countdown(finalDate, function(event) {
