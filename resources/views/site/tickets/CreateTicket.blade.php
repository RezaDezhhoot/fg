<div class="w-full mt-[1rem] lg:mt-[0rem] lg:!w-[34rem]">
    <div>
        <a href="#" class="flex items-center px-[2rem] py-[1rem] bg-white w-max rounded-[1rem] cursor-pointer">
    ...
    <form>
        <div class="mt-[1rem] bg-white rounded-[1rem] p-[2rem] box-page-create-ticket">
            ...
            <div>
                ...
                <div class="box-radio-form-product w-full flex my-[1rem]">
                    <input class="!w-[50%]  !rounded-[0.5rem]" label="مرحله بعد از ثبت سفارش" type="radio" name="first" value="next">

                    <input class="!w-[50%]  !rounded-[0.5rem]" label="مرحله قبل از ثبت سفارش" type="radio" name="first" value="back">
                </div>

                <div class="flex justify-center">
                    <button type="button" class="input-submit-style !rounded-[0.5rem] !w-[15rem] btn-next-page-create-ticket">مرحله بعد</button>
                </div>
            </div>
        </div>

        <div class="mt-[1rem] bg-white rounded-[1rem] p-[2rem] box-page-create-ticket hidden">
            <div class="flex justify-between items-center border-b border-solid pb-[1rem] mb-[1rem] border-[#BDBDC7]">
                <h3 class="font-semibold">ایجاد تیکت جدید</h3>
        ...
        <div class="mt-[1rem] bg-white rounded-[1rem] p-[2rem] box-page-create-ticket hidden">
            ...
            <div>
                <div>
                    <input type="text" class="input-hover w-full bg-[#F8F9FB] border border-[#BDBDC7] rounded-[0.5rem] p-[1rem]" placeholder="لطفا موضوع خود را وارد نمایید">
                </div>

                <div class="my-[0.5rem]">
                    <input type="text" class="input-hover w-full bg-[#F8F9FB] border border-[#BDBDC7] rounded-[0.5rem] p-[1rem]" placeholder="کد سفارش">
                </div>
                
                <div class="my-[0.5rem]">
                    <input type="text" class="input-hover w-full bg-[#F8F9FB] border border-[#BDBDC7] rounded-[0.5rem] p-[1rem]" placeholder="نام محصولی خریداری شده">
                </div>
                
                <div class="my-[0.5rem]">
                    <input type="text" class="input-hover w-full bg-[#F8F9FB] border border-[#BDBDC7] rounded-[0.5rem] p-[1rem]" placeholder="شماره کارتی که با ان پرداخت انجام داده اید">
                </div>
                ...
                <div class="box-radio-form-product w-full my-[0.5rem] grid gap-1 grid-cols-2 lg:grid-cols-4">
                    <input id="Importance" class="!rounded-[0.5rem]" label="کم" type="radio" name="first">
                    <input class="!rounded-[0.5rem]" label="متسوط" type="radio" name="first">
                    <input class="!rounded-[0.5rem]" label="زیاد" type="radio" name="first">
                    <input class="!rounded-[0.5rem]" label="فوری" type="radio" name="first">
                </div>

                <div class="my-[0.5rem]">
                    <textarea class="input-hover w-full bg-[#F8F9FB] border border-[#BDBDC7] rounded-[0.5rem] p-[1rem] h-[15rem]" placeholder="لطفا متن موضوع  خود را وارد نمایید"></textarea>
                </div>
