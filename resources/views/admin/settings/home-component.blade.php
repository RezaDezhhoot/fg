<div>
    <div class="content d-flex flex-column-fluid">
        <div class="container">
            ...
            <x-admin.modal id="CategoryBanner" size="modal-xl" title="افزودن آیتم">
                <div>
                    <x-admin.forms.validation-errors/>
                </div>
                <x-admin.forms.input type="text" id="c-url" label="آدرس" required="true" wire:model.defer="url"/>
                <x-admin.forms.lfm-standalone id="c-image" label="تصویر" :image="$image" required="true" wire:model="image"/>
                <x-admin.forms.input type="text" id="c-title" label="عنوان" required="true" wire:model.defer="title"/>

                <x-slot name="footer">
                    <button type="button" class="btn btn-primary" wire:click="storeCategoryBanner()">ثبت</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">انصراف</button>
                </x-slot>
            </x-admin.modal>
            ...
            <x-admin.forms.form title="صفحه اصلی" :mode="$mode">
                ...
                <x-admin.forms.header title="دسته بندی ها" class="d-flex justify-content-between">
                    <div>
                        <button type="button" class="btn btn-link" wire:click="addCategoryBanner('category_banner')">افزودن</button>
                    </div>
                </x-admin.forms.header>
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        @forelse($category_banner as $id => $item)
                            <tr>
                                <td>{{iteration($loop, $perPage)}}</td>
                                <td>{{$item['url']}}</td>
                                <td>{{$item['title']}}</td>
