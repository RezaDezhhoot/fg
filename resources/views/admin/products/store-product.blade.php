    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            ...
            <x-admin.forms.form title="محصول" :mode="$mode">
                ...
                <x-admin.forms.dynamic-select2 :multiple="true" :data="$oldArticles" text="title" width="12" id="articles"
                                       label="اموزش ها" ajaxUrl="{{ route('admin.feed.articles') }}"
                                       wire:model.defer="articles"/>
