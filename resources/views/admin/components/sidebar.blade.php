        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            return $query->where('status', \App\Models\Order::STATUS_PROCESSING)->orWhere('status', \App\Models\Order::STATUS_DELAY);
				...
				<x-admin.sidebar-link href="{{route('admin.myLanguage')}}"
                	...
                	@endcan
				@can('show_settings')
                    <x-admin.multiplesidebar-link title="تنظیمات" :active="request()->routeIs(['admin.subjects','admin.subjects.store','admin.settings','admin.homes','admin.faqs', 'admin.rules','admin.windows','admin.languages'])" icons="flaticon-settings-1">
