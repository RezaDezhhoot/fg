...
return [
    ...
    */
    'attributes' => [
        ...
        'license' => 'لاینسیس',
        'licenses' => 'لاینسیس ها',
        'manager_mobile' => 'موبایل مدیر محصول',
        'manager_sms' => 'متن پیامک ارسالی به مدیر محصول',
        'discount_type' => 'نوع',
        'discount_amount' => 'مقدار',
        'discount_starts_at' => 'تاریخ شروع',
        'discount_expires_at' => 'تاریخ انقضاء',
        'comment' => 'نظر',
        'answer' => 'پاسخ',
        'rating' => 'امتیاز',
        'is_confirmed' => 'تایید شده',
        'question' => 'سوال',
        'category' => 'دسته',
    ],
];
